...
const CHECKOUT_SETTING_DEFINITIONS: StoreSettingDefinition[] = [
  ...
  {
    key: "APP_FREE_SHIPPING_THRESHOLD",
    configKey: "MontoEnvioGratis",
    label: "Monto minimo para envio gratis",
    description:
      "Si un pedido con envio iguala o supera este monto, la tienda y el panel lo marcan como envio gratis. Por debajo, el envio queda a calcular.",
    section: "Checkout",
    group: "Entrega",
    type: "text",
    fallback: "150000",
  ...
  {
    key: "APP_CORREO_ARGENTINO_API_BASE_URL",
    configKey: "CorreoArgentinoApiBaseUrl",
    label: "API base Correo Argentino",
    description:
      "Base HTTPS de MiCorreo / PAQ.AR para cotizar envios. Si la dejas por defecto, solo completas credenciales y datos de tu cuenta.",
    section: "Checkout",
    group: "Correo Argentino",
    type: "text",
    fallback: "https://api.correoargentino.com.ar/micorreo/v1",
    placeholder: "https://api.correoargentino.com.ar/micorreo/v1",
  },
  {
    key: "APP_CORREO_ARGENTINO_CUSTOMER_ID",
    configKey: "CorreoArgentinoCustomerId",
    label: "Customer ID",
    description:
      "Identificador de cliente provisto por Correo Argentino para cotizar en MiCorreo.",
    section: "Checkout",
    group: "Correo Argentino",
    type: "text",
    placeholder: "0000550997",
  },
  {
    key: "APP_CORREO_ARGENTINO_ORIGIN_POSTAL_CODE",
    configKey: "CorreoArgentinoOriginPostalCode",
    label: "Codigo postal de origen",
    description:
      "CP desde donde sale el pedido. Es el origen que Correo usa para cotizar el envio.",
    section: "Checkout",
    group: "Correo Argentino",
    type: "text",
    placeholder: "8430",
  ...
  {
    key: "APP_CORREO_ARGENTINO_API_USER",
    configKey: "CorreoArgentinoApiUser",
    label: "Usuario API",
    description:
      "Usuario entregado por Correo Argentino para pedir token y consultar tarifas.",
    section: "Checkout",
    group: "Correo Argentino",
    type: "text",
  ...
  {
    key: "APP_CORREO_ARGENTINO_API_PASSWORD",
    configKey: "CorreoArgentinoApiPassword",
    label: "Password API",
    description:
      "Clave privada de la cuenta de Correo Argentino usada para autenticacion.",
    section: "Checkout",
    group: "Correo Argentino",
    type: "password",
    placeholder: "********",
